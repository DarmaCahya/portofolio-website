  ...
  return (
    <section id="contact" className="py-20 md:py-28 bg-section-linear-2 bg-stripe-pattern border-b border-[#1c202c] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="rounded-2xl bg-[#111319]/90 border border-[#232938] backdrop-blur-md p-8 sm:p-12 lg:p-16 text-center space-y-8 max-w-4xl mx-auto shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 pt-4 max-w-3xl mx-auto text-xs font-mono">
            ...
            <a
              ...
              className="p-4 rounded-xl bg-[#161922] border border-[#232938] hover:border-[#38bdf8]/50 text-[#e5e7eb] flex items-center justify-between group transition-all"
            >
