      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            {/* Education Summary */}
            <div className="p-5 rounded-xl bg-[#111319]/90 border border-[#1c202c] backdrop-blur-sm space-y-2 hover:border-[#262c3d] transition-colors shadow-lg">
            ...
            <div className="p-4 rounded-xl bg-[#111319]/90 border border-[#1c202c] backdrop-blur-sm space-y-2 text-xs font-mono shadow-lg">
