  ...
  return (
    <section id="projects" className="py-20 md:py-24 border-b border-[#1c202c] bg-section-linear-3 bg-grid-pattern relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
                ...
                <motion.button
                  ...
                  className={`text-xs font-mono px-3 py-1.5 rounded-md border transition-all ${
                    selectedCategory === cat
                      ? "bg-[#161922] text-[#38bdf8] border-[#38bdf8]/50 font-semibold shadow-sm shadow-cyan-500/10"
        ...
        {/* CLEAN, UNCLUTTERED COMPACT CARD GRID WITH ANIMATED ENTER & EXIT */}
        ...
        {isHomePage && (
          ...
          >
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }}>
              <Link
                href="/projects"
                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-[#161922] text-[#f3f4f6] border border-[#262c3d] hover:border-[#38bdf8]/50 font-mono text-xs uppercase tracking-wider transition-all shadow-md group"
              >
